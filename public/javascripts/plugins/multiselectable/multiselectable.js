...
(function ($) {
    $.fn.multiselectable = function (options) {
        ...
        options = $.extend({
            ...
            '<select multiple="multiple" id="m-selectable" class="form-control" style="border-radius:4px !important;"></select>' +
            '</div>' +
            '<div class="m-selectable-controls">' +
            '<button class="multis-right btn btn-info"></button>' +
            '<button class="multis-left btn btn-danger"></button>' +
            '</div>' +
            '<div class="m-selectable-to"><label for="m-selected"></label>' +
            '<select multiple="multiple" id="m-selected" class="form-control" style="border-radius:4px !important;"></select>' +
            '</div>' +
            '</div>',
